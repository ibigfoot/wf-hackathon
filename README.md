...
This is a demonstration of concept for [Wayfindr] Hackathon. Effectively a thought experiment on how [TFL](https://api.tfl.gov.uk/) and Wayfindr could build / improve on the [TFL api's](http://wayfindr.azurewebsites.net/) with a focus on helping the visually impared. 
